        ...
        <div class="flex justify-center items-center"> 
            ...
            <div>
                ...
                <div id="emailForm" style="display: none;">
                    ...
                    <form method="post" action="{{ route('barangay.profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
            ...
            <div>
                ...
                <div id="passwordForm" style="display: none;">
                    @include('barangay.profile.partials.update-password-form')  
                </div>
            </div>
            ...
            <div>
                ...
                <div id="deleteForm" style="display: none;">
                    @include('barangay.profile.partials.delete-user-form')
                </div>
            </div>  --}}
        </div>
    </div>
